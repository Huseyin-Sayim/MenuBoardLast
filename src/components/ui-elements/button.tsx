...
import type { ButtonHTMLAttributes } from "react"; // 1. HTMLAttributes yerine ButtonHTMLAttributes
...
// 2. Type'ı manuel string yapma, ButtonHTMLAttributes zaten doğrusunu içeriyor
...
export function Button({
                         ...
                         size,
                         className,
                         type = "button", // 3. Default değer atamak her zaman iyidir
                         ...props
                       }: ButtonProps) {
  return (
    <button
      type={type} // 4. Type'ı açıkça geçiyoruz
